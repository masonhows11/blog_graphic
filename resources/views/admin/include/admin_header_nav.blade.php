        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('admin/img/admin-icon.png') }}" class="user-image" alt="User">
                        <span class="hidden-xs">کاربر {{ \Illuminate\Support\Facades\Auth::user()->user_name }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{ asset('admin/img/admin-icon.png') }}" class="img-circle" alt="User">
